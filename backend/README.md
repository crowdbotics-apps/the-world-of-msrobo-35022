...
## Project Structure
    ...
    ├── the_world_of_msrobo_35022  # Django project configurations
...
1. Clone this repo and `cd the_world_of_msrobo_35022`
...
2. Clone this repo and `cd the_world_of_msrobo_35022`
